...
- tag_colors (dict; required): The currently selected tag color (e.g. GREEN) with which the selected tag will be colored. This must be managed by the Dash App."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, text=Component.REQUIRED, entities=Component.UNDEFINED, tag=Component.REQUIRED, tag_colors=Component.REQUIRED, **kwargs):
        self._prop_names = ['id', 'text', 'entities', 'tag', 'tag_colors']
        self._type = 'DashTextAnnotate'
        self._namespace = 'dash_text_annotate'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'text', 'entities', 'tag', 'tag_colors']
